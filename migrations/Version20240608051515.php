 ...
 */
final class Version20240608051515 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE devices.device_event_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE devices.device_type_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE SEQUENCE devices.event_config_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE devices.irrigator_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE devices.irrigator_event_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE SEQUENCE devices.sensor_event_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE devices.device_event (id INT NOT NULL, event_id INT NOT NULL, device_id INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE devices.device_type (id INT NOT NULL, use_bluetooth BOOLEAN NOT NULL, use_wifi_connection BOOLEAN NOT NULL, can_power_controll BOOLEAN NOT NULL, can_manual_controll BOOLEAN NOT NULL, model VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE devices.event_config (id INT NOT NULL, name VARCHAR(255) NOT NULL, can_listen BOOLEAN NOT NULL, can_emit BOOLEAN NOT NULL, listen_key VARCHAR(255) DEFAULT NULL, emit_key VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE devices.irrigator (id INT NOT NULL, zone_id INT NOT NULL, irrigator_type_id INT NOT NULL, position INT NOT NULL, alias VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE devices.irrigator_event (id INT NOT NULL, irrigator_id INT NOT NULL, event_id INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_7648E9C14E142C13 ON devices.irrigator_event (irrigator_id)');
        $this->addSql('CREATE INDEX IDX_7648E9C171F7E88B ON devices.irrigator_event (event_id)');
        $this->addSql('CREATE TABLE devices.irrigator_type (id INT NOT NULL, can_manual_control_irrigation BOOLEAN NOT NULL, can_change_watering_time BOOLEAN NOT NULL, can_change_check_interval BOOLEAN NOT NULL, can_turn_on_turn_off BOOLEAN NOT NULL, name VARCHAR(255) NOT NULL, label VARCHAR(255) NOT NULL, model VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE devices.sensor (id INT NOT NULL, zone_id INT NOT NULL, sensor_type_id INT NOT NULL, treshold_id INT DEFAULT NULL, alias VARCHAR(255) DEFAULT NULL, position INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE devices.sensor_event (id INT NOT NULL, sensor_type_id INT NOT NULL, event_id INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE devices.device ADD CONSTRAINT FK_9E6C24164FFA550E FOREIGN KEY (device_type_id) REFERENCES devices.device_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE devices.device_event ADD CONSTRAINT FK_D625533871F7E88B FOREIGN KEY (event_id) REFERENCES devices.event_config (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE devices.device_event ADD CONSTRAINT FK_D625533894A4C7D4 FOREIGN KEY (device_id) REFERENCES devices.device_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE devices.irrigator_event ADD CONSTRAINT FK_7648E9C14E142C13 FOREIGN KEY (irrigator_id) REFERENCES devices.irrigator_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE devices.irrigator_event ADD CONSTRAINT FK_7648E9C171F7E88B FOREIGN KEY (event_id) REFERENCES devices.event_config (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE devices.sensor_event ADD CONSTRAINT FK_56E4E9B7D8550BD9 FOREIGN KEY (sensor_type_id) REFERENCES devices.sensor_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE devices.sensor_event ADD CONSTRAINT FK_56E4E9B771F7E88B FOREIGN KEY (event_id) REFERENCES devices.event_config (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE devices.device_event_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE devices.device_type_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE account.document_type_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE account.email_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE devices.event_config_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE devices.irrigator_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE devices.irrigator_event_id_seq CASCADE');
        ...
        $this->addSql('DROP SEQUENCE devices.sensor_event_id_seq CASCADE');
        ...
        $this->addSql('ALTER TABLE devices.irrigator_event DROP CONSTRAINT FK_7648E9C14E142C13');
        $this->addSql('ALTER TABLE devices.irrigator_event DROP CONSTRAINT FK_7648E9C171F7E88B');
        ...
        $this->addSql('DROP TABLE devices.device_type');
        $this->addSql('DROP TABLE account.document_type');
        $this->addSql('DROP TABLE account.email');
        $this->addSql('DROP TABLE devices.event_config');
